...
export function DepositRewardsDialog({ farm, open, onOpenChange, onSuccess }: DepositRewardsDialogProps) {
      ...
      <DialogContent className="max-w-md">
        ...
        <div className="space-y-4">
          <p className="text-sm text-muted-foreground">
            Deposit reward tokens into your farm's pools. Tokens will be distributed to stakers.
          </p>
