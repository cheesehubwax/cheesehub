  ...
  return (
    <div className="space-y-6">
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-cheese">1. Acceptance of Terms</h2>
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-cheese">2. Platform Description</h2>
        <p className="text-sm text-muted-foreground leading-relaxed">
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-cheese">3. No Financial Product or Financial Advice</h2>
        <p className="text-sm text-muted-foreground leading-relaxed">
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-cheese">4. Immutable Token Contract</h2>
        <p className="text-sm text-muted-foreground leading-relaxed">
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-cheese">5. Self-Directed Activity & No Custody</h2>
        <p className="text-sm text-muted-foreground leading-relaxed">
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-cheese">6. Open-Source Software & Transparency</h2>
        <p className="text-sm text-muted-foreground leading-relaxed">
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-cheese">7. Eligibility</h2>
        <p className="text-sm text-muted-foreground leading-relaxed">
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-cheese">8. User Responsibilities</h2>
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-cheese">9. Intellectual Property</h2>
        <p className="text-sm text-muted-foreground leading-relaxed">
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-cheese">10. Prohibited Use</h2>
        <p className="text-sm text-muted-foreground leading-relaxed">
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-cheese">11. Third-Party Services</h2>
        <p className="text-sm text-muted-foreground leading-relaxed">
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-cheese">12. Merchandise & Consumer Protection</h2>
        <p className="text-sm text-muted-foreground leading-relaxed">
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-cheese">13. Risk Warnings</h2>
        <p className="text-sm text-muted-foreground leading-relaxed">
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-cheese">14. Tax & Regulatory Compliance</h2>
        <p className="text-sm text-muted-foreground leading-relaxed">
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-cheese">15. No Warranties</h2>
        <p className="text-sm text-muted-foreground leading-relaxed">
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-cheese">16. Limitation of Liability</h2>
        <p className="text-sm text-muted-foreground leading-relaxed">
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-cheese">17. Modifications to Terms</h2>
        <p className="text-sm text-muted-foreground leading-relaxed">
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-cheese">18. Governing Law</h2>
        <p className="text-sm text-muted-foreground leading-relaxed">
