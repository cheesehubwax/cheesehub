      ...
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="space-y-2">
          <h2 className="text-xl font-bold flex items-center gap-2">
            <OpenMojiIcon emoji="" size={18} className="text-primary" /> Create a New DAO
        ...
        <Button onClick={handleCreate} disabled={loading || !paymentMethod || !termsAgreed} className="w-full bg-primary text-primary-foreground" size="lg">
          {loading ? <><Loader2 className="h-4 w-4 animate-spin mr-2" /> Creating DAO...</> : paymentMethod === "cheese" ? <><OpenMojiIcon emoji="" size={18} /> Create DAO (Pay with CHEESE)</> : paymentMethod === "wax" ? <><OpenMojiIcon emoji="" size={18} /> Create DAO (265 WAX)</> : <><OpenMojiIcon emoji="" size={18} /> Select Payment Method</>}
        </Button>
