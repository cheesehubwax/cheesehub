...
- [x] Update CHEESEAir subheading: "and liquidity providers" → "or liquidity providers"
...
- [ ] Banner ads: WaxEDGE placeholder first, legacy yellow banner as second placeholder when two shared slots are open; placeholder must also work on GitHub Pages (bundled asset)
